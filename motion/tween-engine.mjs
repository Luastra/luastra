...
export class TweenEngine {
  ...
  animate({
    ...
    const finishImmediately = durationMs === 0 || this.#reducedMotion();
    ...
    return Object.freeze({
      ...
      cancel() {
        ...
        settled = true;
        const cancelled = subscription?.cancel() ?? false;
        onCancel();
        return cancelled;
      },
    });
