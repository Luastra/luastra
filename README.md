...
> **Release status:** `0.3.0-alpha` is an early public-source release. APIs may
...
This development branch targets **0.3.0-alpha** (unpublished). It adds standalone
HTML documentation and bounded `UI.TextStyle` typography. See
[the development plan](docs/0.3.0-alpha-plan.md) and [typography](docs/typography.md).
...
```sh
curl -fsSLO https://github.com/Luastra/luastra/releases/download/v0.3.0-alpha/luastra-install.mjs
