...
export const generatedPages = Object.freeze([
  ...
  },
  {
    ...
    "module": "0.4.0-alpha release boundary",
    "callable": false,
    ...
    "code": "curl -fsSLO https://github.com/Luastra/luastra/releases/download/v0.4.0-alpha/luastra-install.mjs\nnode luastra-install.mjs \\\n  --manifest=https://github.com/Luastra/luastra/releases/download/v0.4.0-alpha/luastra-release.v1.json",
    "signature": "download → verify → atomic install → doctor",
    "parameters": [],
    "returns": null,
    "name": "Release installation contract",
    "description": "The Node.js bootstrap detects the host, downloads only its archive over HTTPS, verifies the release manifest and archive ledger, then atomically installs the SDK under ~/.luastra/sdk/0.4.0-alpha.",
    "language": "Shell",
    "points": [
  ...
  },
  {
    ...
    "code": "# Every required file is in this release's Assets list:\n# https://github.com/Luastra/luastra/releases/tag/v0.4.0-alpha\n\n# Run from the directory containing the three downloaded files:\nnode ./luastra-install.mjs --manifest=./luastra-release.v1.json",
    "signature": "GitHub Release assets → one transfer directory → verified install",
    "parameters": [],
    "returns": null,
    "name": "Offline installation",
    "description": "On a connected machine, open the v0.4.0-alpha GitHub Release and download three assets: luastra-install.mjs, luastra-release.v1.json, and exactly one SDK archive matching the offline destination machine. Copy those three files, without renaming them, into one directory on the offline machine.",
    "language": "Shell",
    "points": [
      "macOS Apple Silicon (M1 or newer): luastra-sdk-0.4.0-alpha-darwin-arm64.tar.gz.",
      "macOS Intel: luastra-sdk-0.4.0-alpha-darwin-x64.tar.gz.",
      "Linux x64: luastra-sdk-0.4.0-alpha-linux-x64.tar.gz.",
      "Windows x64: luastra-sdk-0.4.0-alpha-win32-x64.tar.gz.",
  ...
  },
  {
    ...
    "points": [
      ...
      "A successful version command prints JSON whose result is PASS and whose version is 0.4.0-alpha.",
  ...
  },
  {
    ...
    "signature": "path:line:column · message · first cause",
    "parameters": [],
    "returns": null,
    "name": "Read analyzer errors",
    "description": "Treat analyzer output as a source location plus a mismatch to repair, not as a verdict on the whole application.",
    "wide": true,
    "points": [
      "Start with the first diagnostic that names one of your source files; later messages may be consequences of that mismatch.",
      "Open the reported line and inspect the complete expression, function call, or table literal—not only the highlighted token.",
      "Compare the required type with the value actually supplied. Here count is declared number, while the uncommented value would be string.",
      "Fix the source contract or value instead of adding :: or any merely to silence the analyzer.",
      "Run luastra check again. A real fix removes the diagnostic without creating a wider, less precise type."
    ],
  ...
  },
  {
    ...
    "sectionTitle": "Luau typing quick reference",
    "module": "Luau 0.731 · --!strict",
    "name": "How to read a check diagnostic",
    "signature": "luau-diagnostic-reading",
    "description": "Shared parameters in the “How to read a check diagnostic” group. A component page links here only when it supports this group.",
    "parameters": [
      {
        "name": "Source location",
        "values": "path plus line and column",
        "description": "Open that exact file and inspect the full surrounding expression."
      },
      {
        "name": "Required side",
        "values": "the declared parameter, return, variable, or field type",
        "description": "This is the contract the code promised to satisfy."
      },
      {
        "name": "Supplied side",
        "values": "the inferred type of the actual value",
        "description": "Trace where that value was created or narrowed."
      },
      {
        "name": "First repair",
        "values": "change the incorrect value or the genuinely incorrect contract",
        "description": "Do not begin with a cast, any, or disabled strict mode."
      },
      {
        "name": "Confirmation",
        "values": "run luastra check again",
        "description": "The original error should disappear while useful type precision remains."
      }
    ],
  ...
  {
    "id": "startup-screens/item-1",
    "routeSlug": "loading-and-failure",
    "routeId": "startup-screens/loading-and-failure",
    "kind": "guide",
    "sectionId": "startup-screens",
    "sectionTitle": "Startup screens",
    "module": "app/startup",
    "callable": false,
    "useWhen": "Read this page when you need to apply Loading and failure, verify its exact contract, and adapt the example without bypassing validation or host boundaries.",
    ...
    "signature": "render() / renderFailure() -> UI.Node",
    "parameters": [],
    "returns": null,
    "name": "Loading and failure",
    "description": "Use the same Luau file to describe both states.",
    "previousPageId": null,
    "nextPageId": null,
    "relatedPageIds": [],
    "relatedPageRoles": []
  ...
  },
  {
    ...
    "availability": "Source API in 0.4.0-alpha; the public installer targets 0.4.0-alpha. Verify host-specific behavior against the selected SDK.",
  ...
  },
  {
    ...
    "parameters": [
      ...
      },
      {
        "name": "textStyle",
        "values": "UI.TextStyle?",
        "description": "Local packaged font and bounded size, weight, lineHeight and fallback. Requires the 0.3 source SDK; omitted fields retain defaults."
      },
      {
        "name": "padding",
        "values": "none | xs | sm | md | lg | xl | responsive",
  ...
  },
  {
    ...
    "expectedOutcome": "A validated declarative node appears after it is returned as part of the current render tree.",
    "failureGuidance": "Invalid fields, duplicate IDs, unsupported child combinations, or a missing ui.render capability fail during check, render-tree validation, or host startup.",
    "availability": "Experimental Constellation Orbit API in 0.4.0-alpha. Verify it against the selected SDK before depending on its shape.",
    "mentalModel": "This is a declarative node: Application.render describes it again from current state, while the host matches its stable id to the existing view.",
  ...
  },
  {
    ...
    "parameters": [
      ...
      },
      {
        "name": "textStyle",
        "values": "TextStyle?",
        "description": "Checked textStyle field of UI.Input; its exact admitted type is TextStyle?."
      },
      {
        "name": "textAlign",
        "values": "string?",
  ...
  {
    "id": "ui/item-41",
    "routeSlug": "text-style",
    "routeId": "ui/text-style",
    "kind": "type",
    "sectionId": "ui",
    "sectionTitle": "Interface components",
    "module": "luastra/ui",
    ...
    "commonMistakes": [
      "Using an undeclared font asset.",
      "Assuming a Latin-only font covers every script.",
      "Expecting a font-ready event or container-level inheritance."
    ],
    "callable": false,
    "useWhen": "Use textStyle on Text, Button, Link, TextInput, Code or CodeBlock. Font references come from Assets.font; size is an integer 8–128 in sixteenths of a rem, weight is 100–900 in steps of 100, and lineHeight is 1–3 in steps of 0.01. Fallback is sans, serif or mono. Styles are local to the text component; omitted fields keep existing defaults.",
    "code": "export type TextStyle = {\n    font: Assets.Font?,\n    size: number?,\n    weight: number?,\n    lineHeight: number?,\n    fallback: (\"sans\" | \"serif\" | \"mono\")?,\n}",
    "signature": "export type TextStyle = {\n    font: Assets.Font?,\n    size: number?,\n    weight: number?,\n    lineHeight: number?,\n    fallback: (\"sans\" | \"serif\" | \"mono\")?,\n}",
    "parameters": [
      {
        "name": "font",
        "values": "Assets.Font?",
        "description": "Checked font field of UI.TextStyle; its exact admitted type is Assets.Font?."
      },
      {
        "name": "size",
        "values": "number?",
        "description": "Checked size field of UI.TextStyle; its exact admitted type is number?."
      },
      {
        "name": "weight",
        "values": "number?",
        "description": "Checked weight field of UI.TextStyle; its exact admitted type is number?."
      },
      {
        "name": "lineHeight",
        "values": "number?",
        "description": "Checked lineHeight field of UI.TextStyle; its exact admitted type is number?."
      },
      {
        "name": "fallback",
        "values": "(\"sans\" | \"serif\" | \"mono\")?",
        "description": "Checked fallback field of UI.TextStyle; its exact admitted type is (\"sans\" | \"serif\" | \"mono\")?."
      }
    ],
    "returns": "UI.Node — a declarative node in the new render tree.",
    "name": "UI.TextStyle",
    "description": "UI.TextStyle declares a packaged font, fallback family, bounded text size, weight and line height. Constructors translate it into validated style classes without arbitrary CSS or changes to the VM protocol.",
    "previousPageId": "ui/item-40",
    "nextPageId": null,
    "relatedPageIds": [
      "ui/item-7"
    ],
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; presentation follows host and reduced-motion policy.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; supported consumers vary by asset kind.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; host-independent and synchronous.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; persistence support is host-dependent.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; URL integration is a separate host capability.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; exact background timing remains host-dependent.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha capability API in 0.4.0-alpha; verify each claimed host independently.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; production backend deployment remains application-owned.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.4.0-alpha; background playback and system controls require target-specific verification.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha diagnostic API in 0.4.0-alpha.",
    "callable": true,
  ...
  },
  {
    ...
    "previousPageId": "manifest/item-5",
    "nextPageId": "manifest/item-7",
    "relatedPageIds": [],
    "relatedPageRoles": []
  },
  {
    "id": "manifest/item-7",
    "routeSlug": "startup-configuration",
    "routeId": "manifest/startup-configuration",
    "kind": "guide",
    "sectionId": "manifest",
    "sectionTitle": "Project manifest",
    "module": "luastra.json · schema v2",
    ...
    "previousPageId": "manifest/item-6",
    "nextPageId": "manifest/item-8",
    "relatedPageIds": [],
    "relatedPageRoles": []
  },
  {
    "id": "manifest/item-8",
    "routeSlug": "complete-web-project",
    "routeId": "manifest/complete-web-project",
    "kind": "guide",
    "sectionId": "manifest",
    "sectionTitle": "Project manifest",
    "module": "luastra.json · schema v2",
    ...
    "previousPageId": "manifest/item-7",
    "nextPageId": null,
    "relatedPageIds": [],
    "relatedPageRoles": []
  },
    ...
    "parameters": [
      {
        ...
        "description": "create, check, test, run, bundle, and static web build have automated coverage for the release checkout."
      },
      {
