...
export const generatedPages = Object.freeze([
  ...
  },
  {
    ...
    "module": "0.3.0-alpha release boundary",
    "callable": false,
    ...
    "code": "curl -fsSLO https://github.com/Luastra/luastra/releases/download/v0.3.0-alpha/luastra-install.mjs\nnode luastra-install.mjs \\\n  --manifest=https://github.com/Luastra/luastra/releases/download/v0.3.0-alpha/luastra-release.v1.json",
    "signature": "download → verify → atomic install → doctor",
    "parameters": [],
    "returns": null,
    "name": "Release installation contract",
    "description": "The Node.js bootstrap detects the host, downloads only its archive over HTTPS, verifies the release manifest and archive ledger, then atomically installs the SDK under ~/.luastra/sdk/0.3.0-alpha.",
    "language": "Shell",
    "points": [
  ...
  },
  {
    ...
    "code": "# Every required file is in this release's Assets list:\n# https://github.com/Luastra/luastra/releases/tag/v0.3.0-alpha\n\n# Run from the directory containing the three downloaded files:\nnode ./luastra-install.mjs --manifest=./luastra-release.v1.json",
    "signature": "GitHub Release assets → one transfer directory → verified install",
    "parameters": [],
    "returns": null,
    "name": "Offline installation",
    "description": "On a connected machine, open the v0.3.0-alpha GitHub Release and download three assets: luastra-install.mjs, luastra-release.v1.json, and exactly one SDK archive matching the offline destination machine. Copy those three files, without renaming them, into one directory on the offline machine.",
    "language": "Shell",
    "points": [
      "macOS Apple Silicon (M1 or newer): luastra-sdk-0.3.0-alpha-darwin-arm64.tar.gz.",
      "macOS Intel: luastra-sdk-0.3.0-alpha-darwin-x64.tar.gz.",
      "Linux x64: luastra-sdk-0.3.0-alpha-linux-x64.tar.gz.",
      "Windows x64: luastra-sdk-0.3.0-alpha-win32-x64.tar.gz.",
  ...
  },
  {
    ...
    "points": [
      ...
      "A successful version command prints JSON whose result is PASS and whose version is 0.3.0-alpha.",
  ...
  },
  {
    ...
    "availability": "Source API in 0.3.0-alpha; the public installer targets 0.3.0-alpha. Verify host-specific behavior against the selected SDK.",
  ...
  },
  {
    ...
    "expectedOutcome": "A validated declarative node appears after it is returned as part of the current render tree.",
    "failureGuidance": "Invalid fields, duplicate IDs, unsupported child combinations, or a missing ui.render capability fail during check, render-tree validation, or host startup.",
    "availability": "Experimental Constellation Orbit API in 0.3.0-alpha. Verify it against the selected SDK before depending on its shape.",
    "mentalModel": "This is a declarative node: Application.render describes it again from current state, while the host matches its stable id to the existing view.",
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; presentation follows host and reduced-motion policy.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; supported consumers vary by asset kind.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; host-independent and synchronous.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; persistence support is host-dependent.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; URL integration is a separate host capability.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; exact background timing remains host-dependent.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha capability API in 0.3.0-alpha; verify each claimed host independently.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; production backend deployment remains application-owned.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha API in 0.3.0-alpha; background playback and system controls require target-specific verification.",
    "callable": false,
  ...
  },
  {
    ...
    "availability": "Public-source alpha diagnostic API in 0.3.0-alpha.",
    "callable": true,
