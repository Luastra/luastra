...
const typePurpose = (moduleName, name) => {
  ...
  if (name === "TextStyle") return "UI.TextStyle declares a packaged font, fallback family, bounded text size, weight and line height. Constructors translate it into validated style classes without arbitrary CSS or changes to the VM protocol.";
